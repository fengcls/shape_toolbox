function [vertex,face,scalarname,scalar] = read_vtk_scalar(filename, verbose)
...
% a list of vertices, the first column is 1, the second column is vertex id
% read vertex ids
if(info == 'V')
